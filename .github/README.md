...
[`@aws-sdk/client-sagemaker-runtime`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-runtime/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aTGYaNU+pETdrMtuyfPnaoxCrmiovWp7Y+w2UoUz8eIXmgRr8E+9VkWWnWxtA5cG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-runtime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime@3.910.0/index.min.mjs": "sha384-aTGYaNU+pETdrMtuyfPnaoxCrmiovWp7Y+w2UoUz8eIXmgRr8E+9VkWWnWxtA5cG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-runtime/blob/refs/tags/3.910.0/LICENSE
```
